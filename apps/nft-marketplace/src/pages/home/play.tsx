    ...
    <div className="xl:grid xl:grid-cols-2 xl:gap-2 px-[160px]">
      ...
      <div className="grid grid-rows-3 grid-flow-col text-[black] min-height">
        <div className="flex items-center bg-[#FBC625] ">
          ...
          <div className="mt-3 font-inter text-[#17161A] text-[16px] leading-6 width-8/10">
        ...
        <div className="flex bg-[#3D3B44] items-center">
          <div className="flex items-center justify-center font-drone text-4xl text-white w-[10rem]">
            2
          </div>
          <div className="mt-3 font-inter text-[#D6D6D6] width-9/10 text-[16px] leading-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laborisfds.
          </div>
        ...
        <div className="flex bg-[#2A282F] items-center">
          ...
          <div className="mt-3 font-inter text-[#89888B] width-9/10 text-[16px] leading-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laborisfds.
          </div>
